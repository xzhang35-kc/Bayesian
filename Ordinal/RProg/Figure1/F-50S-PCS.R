...
setwd("C:/ZXiao/MVP-Ordinal-P1/Figure1/PX-GS-Simu-PCS/Simu50S5D-UX")
...
################PMDA#################################################################################################
#####################################################################################################################
#setwd("C:/ZXiao/MVP-Ordinal-P1/Figure1/PX-GSM-Simu-PCS/Simu50S5D-UX")
#Beta <- matrix(scan("CorrOrdBeta.dat"),ncol=2,byrow=T)
#R <- matrix(scan("CorrOrdR.dat"),ncol=25,byrow=T)
#WR <- matrix(scan("CorrOrdSig.dat"),ncol=25,byrow=T)
#Gama <- matrix(scan("CorrOrdGama.dat"), ncol=20, byrow=T)
...
setwd("C:/ZXiao/MVP-Ordinal-P1/Figure1/PX-MH-Simu-PCS/Simu50S5D-UX")
Beta <- matrix(scan("CorrOrdBeta.dat"),ncol=2,byrow=T)
R <- matrix(scan("CorrOrdR.dat"),ncol=25,byrow=T)
