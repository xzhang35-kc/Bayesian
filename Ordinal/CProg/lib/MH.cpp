...
// obtain covariance matrix RR from WR for the mixed data which used in the posterior density calculation
...
// computing the (1/2) log deternimation of a positive definite matrix A.
// A is not changed.
